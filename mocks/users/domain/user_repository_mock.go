...
// FindByPhone provides a mock function for the type MockUserRepository
func (_mock *MockUserRepository) FindByPhone(ctx context.Context, phone domain.Phone) (*domain.User, error) {
	...
	var r0 *domain.User
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, domain.Phone) (*domain.User, error)); ok {
		return returnFunc(ctx, phone)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, domain.Phone) *domain.User); ok {
	...
	if returnFunc, ok := ret.Get(1).(func(context.Context, domain.Phone) error); ok {
...
//   - ctx context.Context
//   - phone domain.Phone
func (_e *MockUserRepository_Expecter) FindByPhone(ctx any, phone any) *MockUserRepository_FindByPhone_Call {
...
func (_c *MockUserRepository_FindByPhone_Call) Run(run func(ctx context.Context, phone domain.Phone)) *MockUserRepository_FindByPhone_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg1 domain.Phone
		if args[1] != nil {
			arg1 = args[1].(domain.Phone)
		}
		run(
			arg0,
			arg1,
...
func (_c *MockUserRepository_FindByPhone_Call) Return(user *domain.User, err error) *MockUserRepository_FindByPhone_Call {
	_c.Call.Return(user, err)
	return _c
}

func (_c *MockUserRepository_FindByPhone_Call) RunAndReturn(run func(ctx context.Context, phone domain.Phone) (*domain.User, error)) *MockUserRepository_FindByPhone_Call {
	_c.Call.Return(run)
	return _c
}
