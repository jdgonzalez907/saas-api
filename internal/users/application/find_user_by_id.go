...
type FindUserByIDUseCase interface {
	Execute(ctx context.Context, id int64, userID int64) (*domain.User, error)
}
...
func (u *findUserByIDUseCase) Execute(ctx context.Context, id int64, _ int64) (*domain.User, error) {
