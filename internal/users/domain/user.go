...
var (
	...
	ErrChangingPersonalInformation = errors.New("could not update user personal details")
	ErrChangingPhone               = errors.New("could not change user contact phone number")
	ErrChangingEmail               = errors.New("could not change user contact email address")
